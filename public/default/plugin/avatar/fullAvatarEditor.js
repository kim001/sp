function fullAvatarEditor() {
	...
	var file			= gxunc+'/public/default/plugin/avatar/fullAvatarEditor.swf';		//flash文件的路径
	var	version			= "10.1.0";						//播放该flash所需的最低版本
	var	expressInstall	= gxunc+'/data/avatar/expressInstall.swf';		//expressInstall.swf的路径
